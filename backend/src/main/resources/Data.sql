...
VALUES ('Rua Teste', 1, 'Complemento Teste1', 'Vila Teste', 'São Paulo', '11111-111', 24),
...
VALUES ('$2a$10$5DkTh9Vdg9etHZig.1w1puvxHCtYNDto8CwJT6nNvlcDX1fyIoXi2', 'usuario.teste1'),
...
VALUES ('email.teste1@teste.com.br', '1111111-1111'),
...
VALUES (0, 1, '1990-10-10', 1, null, 0, 1, 0, 1, '147.228.350-39', 'null', 'Adminsitrador Teste', 'Funcionario', 0),
       (1, 2, '1990-10-10', 2, null, 1, 2, 0, 2, '239.812.690-04', null, 'Atendente Teste', 'Funcionario', 1),
       (null, 3, '1990-10-10', 3, null, 0, 3, 0, 3, '804.635.770-78', null, 'Paciente Teste', 'Paciente', 3),
       (null, 4, '1990-10-10', 4, 1, 0, 4, 0, 4, '508.868.960-88', 111111, 'Medico Teste', 'Medico', 2);

INSERT INTO AGENDAMENTO (ANDAMENTO, DATA_AGENDAMENTO, HORA_INICIO, HORA_TERMINO, MEDICO_ID, PACIENTE_ID, UNIDADE_ID)
VALUES (0, '2023-01-10', '09:00', '10:00', 4, 3, 1),

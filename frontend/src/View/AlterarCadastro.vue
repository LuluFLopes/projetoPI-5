<template>
  <div class="primeira-div">
    ...
    <div class="div-principal">
      <h1 class="titulo-principal">Alterar Cadastro</h1>
      <v-card class="cartao-principal">
        ...
        <div class="div-ternaria">
          ...
          <v-select class="campos-padrao campo-final" label="Tipo de Cadastro" v-model="tipoCadastro"
                    :items="listaTiposCadastros" @change="ativarTipoDeCadastro" :disabled="true">
          </v-select>
        </div>
        <v-divider/>
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      urlBuscarUsuario: 'http://localhost:8081/pacientes/alterar',
      alertaLigado: false,
      tipoAlerta: '',
      msgAlerta: '',
      modal: false,
